...
:version: SVN: $Id: ToutiaoUniquedb.py 2430 2018-07-31 01:30:48Z zhangyi $
"""
from pymongo.errors import *
from cdspider.database.base import ToutiaoUniquedb as BaseToutiaoUniquedb
from .Mongo import Mongo, SplitTableMixin

class ToutiaoUniquedb(Mongo, BaseToutiaoUniquedb, SplitTableMixin):

    __tablename__ = 'ToutiaoUnique'

    def __init__(self, connector, table=None, **kwargs):
        super(ToutiaoUniquedb, self).__init__(connector, table = table, **kwargs)
    ...
    def insert(self, obj, ctime):
        ...
        try:
            _id = super(ToutiaoUniquedb, self).insert({"unid": unid, "ctime": ctime}, table=table)
            if _id:
    ...
    def _table_name(self, unid):
        return super(ToutiaoUniquedb, self)._collection_name(unid[0:1])
