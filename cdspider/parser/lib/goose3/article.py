...
class Article(object):
    ...
    @property
    def top_node_html(self):
        return self._top_node_html
    ...
    @property
    def attaches(self):
        ''' list(str): A listing of attaches as parsed from the meta tags
    ...
    def add_additional_data(self, key, val):
        self._additional_data.update({key: val})
